            ...
            <div class="row mb-7 gy-4">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div>
                        ...
                        <p class="mb-0">Explore exciting opportunities in the exploration, mining, and trading of gold. Work with Explicit Mineral Hub.</p>
                    </div>
                </div>
            ...
            <div class="row" id="ft-links">
                ...
                <div class="col">
                    ...
                    <div class="collapse d-lg-block" id="collapseCommunity" data-bs-parent="#ft-links">
                        <ul class="list-unstyled mb-0 py-3 py-lg-0">
                            <li class="mb-2">
                                <a href="mailto:info@explicitmineralhublimited.com" class="text-decoration-none text-reset">Support</a>
                            </li>
                             <li class="mb-2">
                                <a href="mailto:info@explicitmineralhublimited.com" class="text-decoration-none text-reset">info@explicitmineralhublimited.com</a>
                             </li>
                            <li class="mb-2">
                                <a href="mailto:info@explicitmineralhublimited.com" class="text-decoration-none text-reset">Career</a>
                            </li>
                            <li class="mb-2">
            ...
            <div class="row align-items-center">
                <div class="col-md-9">
                    <div class="small mb-3 mb-lg-0">
                        Copyright &copy; <?= date('Y'); ?> Explicit Mineral Hub Limited. All rights reserved.
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-md-end d-flex align-items-center justify-content-md-end">
                        ...
                        <div class="ms-3 d-flex gap-2">
                            <a href="https://www.instagram.com/explicitmineralhub" class="btn btn-instagram btn-light btn-icon">
                            ...
                            <a href="https://www.linkedin.com/company/explicit-mineral-hub-limited" class="btn btn-linkedin btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
                                </svg>
                            </a>
                            <a href="https://www.tiktok.com/@explicitmineralhub" class="btn btn-tiktok btn-icon">
