        ...
        <div class="container pb-xl-9 pb-5">
            <div class="row align-items-center g-4">
                <div class="col-lg-6 col-md-12">
                        ...
                        <p class="lead mb-4 text-gradient-gold fw-bold">The Gold Standard of Mining in Sierra Leone.</p>
                        <p class="mb-6 me-xl-6">
                        We are a registered Sierra Leonean company established in November 2025 under the Companies Act of Sierra Leone. We provide expert consultancy in exploration, mining as well as Gold trading within Sierra Leone and beyond. We have established ourselves strategically to assist mining groups around the globe with practical skill to improve the mining industry.
                        </p>
                        <p class="mb-6 me-xl-6">
                        Explicit Mineral Hub Limited support investors (both domestic and foreign) in gold exploration, mining, purchasing and supply. We are among the leading mining services industries in West-Africa with our head office in Freetown, Sierra Leone. We have a huge base of satisfied clients within Africa and other continents at large.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                ...
                <div class="col-lg-5 col-md-6 col-12" data-cue="slideInLeft">
                    <div data-cue="fadeIn">
                        ...
                        <div class="mb-5 mt-4">
                            ...
                            <p class="mb-0 lead">Explicit Mineral Hub Limited has a focus to provide excellent and reliable services to its cherished clients across the globe.</p>
                        </div>
                    ...
                    <div class="mt-md-5">
                        ...
                        <ul class="list-unstyled mb-5">
                           <li class="mb-2 d-flex">
                                ...
                                <span class="ms-2">Based on our understanding of the regional geology of Sierra Leone and the resilient social license achieved by our team of expertise, we assist our client to locate and access potential mining areas for prospective investments.</span>
                           </li>
                           <li class="mb-2 d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill text-success mt-1" viewBox="0 0 16 16">
                                    <path
        ...
        <div class="container">
            ...
            <div class="row g-lg-7 gy-5">
                <div class="col-lg-4 col-md-4">
                    ...
                    <p class="">Explicit Mineral Hub strive to source foreign and local Partnership to enhance and promote Mining in West Africa, as a tool for Development.</p>
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <p class="">To acquire potential Gold Concessions in the West African Sub-region with Sierra Leone as the main concentration.</p>
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <p class="mb-0">Explicit Mineral Hub to be a preferred entity noted for environmental and safety friendly practices with respect to the MDG goal 7, ensuring environmental sustainability.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 xol-12">
                    <div class="text-center mb-7">
                        ...
                        <h2 class="mt-3">The Minds Behind the Hub</h2>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-7 col-md-12">
                                            <div class="card-body p-4 px-xl-0">
                                                ...
                                                <p class="card-text lead mb-7">
                                                    Alhassan Mohammed is a seasoned mining professional with more than two decades of hands-on and leadership experience in the exploration and development of mineral resources. As Director of Explorations at Explicit Mineral Hub Limited, he provides strategic oversight for all exploration programs, ensuring technical excellence, operational efficiency, and alignment with the company’s long-term growth objectives.
                                                    <br>
